data_source= fullfile(pwd,'Data','Fe_ei196.sqw');
proj.u = [1,0,0];
proj.v = [0,1,0];
pos = [1,1,0];
...
%1)
outfile = fullfile(pwd,'Data','Fe_ei196shift110.sqw');
...
%4)
outfile = fullfile(pwd,'Data','Fe_ei196allSym.sqw');

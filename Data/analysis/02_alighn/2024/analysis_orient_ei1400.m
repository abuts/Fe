%%=============================================================================
%       Realign the crystal: Ei=1400 meV
% =============================================================================
...
data_source =fullfile(sqw_dir,'Fe_ei1400.sqw');
...
% -----------------------------------------------------------------
% Plane in horizontal:
w2el=cut_sqw(data_source,proj1,0.05,0.05,[-0.1,0.1],[-20,20],'-nopix');
plot(w2el);lz 0 15;grid on;keep_figure;
w2tr=cut_sqw(data_source,proj1,[-0.1,0.1],0.05,0.05,[-20,20],'-nopix');
plot(w2tr);lz 0 15;grid on;keep_figure
% select 
w2el=cut_sqw(data_source,proj,0.05,0.05,[-0.1,0.1],[-20,20],'-nopix');
...
rlu=[-1,-3,0; 1,-3,0; -1,11,0; 1,11,0; 7,5,0; -1,7,0; 0,-3,-3; 0,-3,3; 0,3,3; 0,3,-3];

% Get positions of Bragg peaks:
radial_cut_length=1.5; radial_bin_width=0.05; radial_thickness=0.3;
trans_cut_length =2; trans_bin_width=0.05; trans_thickness=0.3;
energy_window=40;
opt={'gaussian'};
...
% get parameters for gen_sqw aligned crstal generation 

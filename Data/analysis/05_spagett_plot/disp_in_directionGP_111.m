...
%cuts_map('sGP_Ei800_allSym_bg_rem_ff_corr.fig') = [200;450]; % All cuts in
%all symmetrical directions added together.
cuts_map('sGP_Ei800_maxFFC_bg_rem_ff_corr') = [100;450]; % Single cut in direction of maximal energy transfer range

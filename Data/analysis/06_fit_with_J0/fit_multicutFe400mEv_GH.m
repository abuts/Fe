...
cuts_list = cuts2fit400.cutsF_list(2);
...
% end
if isfield(cuts2fit400,'bg_par_010off200')
    if numel(cuts_list) == 3    
        bg_par = {cuts2fit400.bg_par_010off000.p,cuts2fit400.bg_par_010off100.p,cuts2fit400.bg_par_010off200.p};
    else
...
[fit_res_400fix_bg,res_name] = fit_multicuts_along_direction(...
    cuts_list,'FitEn_cut400ref200_2D',dir_name,cut_en,dE_step,half_dE);
    %cl,'En_cuts800',dir_name,cut_en,dE_step,half_dE);
beep
beep
beep
fit_res_400 = fit_res_400fix_bg;
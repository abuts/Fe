...
if ~isfile(bg_file)
    sproj200 = kf_sphere_proj(200);
    w2_200meV = cut_sqw(data_src200,sproj200,[0,10],[0,0.4,85],[-180,180],[-20,2,170],'-nopix');
...
sqw2_no_bg = sqw_op(data_src200,@remove_background,{w2_200meV,F},'outfile',target);

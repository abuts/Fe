...
data_src1400 =fullfile(sqw_dir,'Fe_ei1400_no_noisy_det.sqw'); % it is aligned and generated with alignment data
target = fullfile(sqw_dir,'Fe_ei1400_no_noisy_det.sqw');
if ~isa('src1400','var') || ~isa(src1400,'sqw')
    src1400 = sqw(data_src1400);
end

bg_file = 'w2_1400meV_nnd_bg.mat';
if ~isfile(bg_file)
...
if isfile(target)
    ...
    sqw1400_no_bg = sqw_op(src1400,@remove_noize_bckg,{w2_14,F},'outfile',target);
end

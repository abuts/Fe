...
data_src400 =fullfile(sqw_dir,'w4_400meV_model.sqw');
target = fullfile(sqw_dir,'Fe_ei401_model_no_bg_4D.sqw');
if ~isa('src400','var') || ~isa(src400,'sqw')
    src400 = sqw(data_src400);
end

bg_file = 'w4Bz_400meV_bg_model.mat';
if ~isfile(bg_file)
...
if isfile(target)
    ...
    F = griddedInterpolant({x1,x2,x3,x4},avBg.s);

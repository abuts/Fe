function make_sqw_ei401_sym_refl
...
sqwname='Fe_ei401_align_sym3.sqw';
...
gen_sqw (spe_file,"", sqw_file, efix, emode, alatt, angdeg,...
         u, v, psi, omega, dpsi, gl, gs,'transform_sqw', ...
         @(x)symmetrise_sqw(x,{ ...
         SymopReflection('norm',[0,0,1]), ...
         SymopReflection('norm',[0,1,0]), ...
         SymopReflection('norm',[1,0,0])} ...
         ));

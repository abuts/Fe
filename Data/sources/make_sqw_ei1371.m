...
sqwname_base='Fe_ei1371_base.sqw';
sqwname_all='Fe_ei1371_all.sqw';
...
% Create sqw file
% Base temperature only
gen_sqw (spe_file_base, par_file, sqw_file_base, efix, emode, alatt, angdeg,...

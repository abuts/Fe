...
% G1
[spe_file,psi]=build_spefilenames([indir,filesep,'MAP*_4to1_102.nxspe'],15835:15880,0,2,90);
%% G2
[spe_file,psi]=build_spefilenames([indir,filesep,'MAP*_4to1_102.nxspe'],15881:15925,1,2,89,spe_file,psi);
%% G3
[spe_file,psi]=build_spefilenames([indir,filesep,'MAP*_4to1_102.nxspe'],15926:15948,-2,-2,-46,spe_file,psi);
%% G4
[spe_file,psi]=build_spefilenames([indir,filesep,'MAP*_4to1_102.nxspe'],15949:15965,-1,-2,-33,spe_file,psi);

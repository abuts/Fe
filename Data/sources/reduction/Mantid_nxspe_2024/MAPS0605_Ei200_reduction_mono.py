...
#------------------------------------------------------------------------------------#
   ...
   def def_main_properties(self):
       ...
       #
       prop['incident_energy'] = 195 # estimated to get elastic line at the centre. Bining accuracy does not allow
...
####get reduction parameters from properties above, override what you want locally ###
   ...
   # 
    ...
    Eel = estimate_elastic_line_en('SR_MAP011270_spe',(-20,0.25,20))

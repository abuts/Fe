""" Cycle 10/02 Iron data EI ~ 1400
    MAPS reduction script to use pre-calculated vanadium integral for absolute units conversion 
    Absolute units vanadium integral is calculated  by neighbouring MAPS_Ei1400_reduction_mono.py script.
...
#       list(range(15618,15646))+ # Room temperature
#       list(range(15647,15654))+ # cooling
#       list(range(15654,15724))+ # base
#       list(range(15724,15730))+ # warming
#       list(range(15730,15733))+ # Rum temperature
#       list(range(15733,15740))+ # cooling
#       list(range(15740,15835))  # base
runs = (
     list(range(15618,15646)) 
     + list(range(15647,15654))
     + list(range(15654,15724)) 
     + list(range(15724,15730)) 
     + list(range(15730,15733)) 
     + list(range(15733,15740)) 
     + list(range(15740,15835))
)
print(runs)
# Define list of angles runs used by the program. 
phi  = (
     list(np.arange(0,28,1))
     + list(np.arange(28,35,1))
     + list(np.arange(35,46,1)) + list(np.arange(0,-46,-1)) + list(np.arange(-44.5,-31.5,1))
     + list(np.arange(-31.5,-25.5,1))
     + list(np.arange(-25.5,-22.5,1))
     + list(np.arange(-22.5,-15.5,1))
     + list(np.arange(-15.5,45.5,1)) +list(np.arange(-31.5,-16.5,1))+list(np.arange(0,19,1))
)
...
#------------------------------------------------------------------------------------#
   ...
   def def_main_properties(self):
       ...
       prop['monovan_run'] = 16153 #  vanadium run in the same configuration as your sample 
...
##### Here one sets up folders where to find input data and where to save results ####
    ...
    set_data_dir('ei1400A_Cycle_10_02','cycle10_02','ei1400')    
...
#### uncomment rows below to generate web variables and save then to transfer to   ###
    ...
    file = os.path.join(run_dir,'reduce_vars_Ei1400.py')

""" Cycle 09/05 Iron data
    MAPS reduction script to estimate location of elastic line and correctness 
    of incident energy estimate
...
#------------------------------------------------------------------------------------#
   ...
   def def_main_properties(self):
       ...
       #
       prop['incident_energy'] = 400 # estimated to get elastic line at the centre. Bining accuracy does not allow
                                     # to identify elastic line position wich higher accuracy
       prop['energy_bins'] =[-20,1,398]

       # the range of files to reduce. This range ignored when deployed from autoreduction,
       # unless you going to sum these files. 
       # The range of numbers or run number is used when you run reduction from PC.
       #ws = mtd['w1']
       prop['sample_run'] = 15052 # 
       prop['wb_run']     = 15182
       #
       ...
       prop['monovan_run'] = 15181 #  vanadium run in the same configuration as your sample 
...
#------------------------------------------------------------------------------------#
   ...
   def def_advanced_properties(self):
      ...
      """
      prop = {}
      prop['map_file'] = "4to1_095.map"  # "parker_rings.map"
      prop['monovan_mapfile'] = "4to1_mid_lowang.map"
      prop['hardmaskOnly']="4to1_095.msk" #maskfile # disable diag, use only hard mask
      #prop['hard_mask_file'] = ""
...
##### Here one sets up folders where to find input data and where to save results ####
    ...
    set_data_dir('ei400_Cycle_09_05','cycle09_05')    
...
####get reduction parameters from properties above, override what you want locally ###
   ...
   # 
    ...
    red_run_MAP15052 = rd.run_reduction()
    
    Eel = estimate_elastic_line_en(red_run_MAP15052,(-40,1,398))

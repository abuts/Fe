...
#------------------------------------------------------------------------------------#
   ...
   def def_main_properties(self):
       ...
       prop['energy_bins'] =[-20,2.5,398]

       # the range of files to reduce. This range ignored when deployed from autoreduction,
       # unless you going to sum these files. 
       # The range of numbers or run number is used when you run reduction from PC.
       #ws = mtd['w1']
       prop['sample_run'] = 15181 # 
       prop['wb_run']     = 15182
       #
...
##### Here one sets up folders where to find input data and where to save results ####
    ...
    #import importlib
    #importlib.reload(fe_utilities)
    set_data_dir('ei400_Cycle_09_05','cycle09_05','vanadium')    
...
####get reduction parameters from properties above, override what you want locally ###
   ...
   # 
    ...
    red_vanadium_MAP15181 = rd.run_reduction()
    
    Eel = estimate_elastic_line_en(red_vanadium_MAP15181,(-40,2,398))

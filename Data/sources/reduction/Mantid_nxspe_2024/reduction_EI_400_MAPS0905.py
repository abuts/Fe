""" Cycle 09/05 Iron data
    ...
    Absolute units vanadium integral is calculated  by neighbouring MAPS_Ei400_reduction_mono.py script.
...
#------------------------------------------------------------------------------------#
   ...
   def def_advanced_properties(self):
      ...
      prop['hardmaskPlus']="4to1_095.msk" #hardmaskOnly disable diag, use only hard mask
      #prop['hard_mask_file'] = ""
...
##### Here one sets up folders where to find input data and where to save results ####
    ...
    set_data_dir('ei400_Cycle_09_05','cycle09_05','ei400')

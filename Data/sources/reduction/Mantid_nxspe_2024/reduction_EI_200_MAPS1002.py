...
#------------------------------------------------------------------------------------#
   ...
   def def_main_properties(self):
       ...
       prop['energy_bins'] =[-20,1,162] # Higher range picks next energy
...
#------------------------------------------------------------------------------------#
   ...
   def do_preprocessing(self,reducer,ws):
        ...
        """
        anf_TGP = 18.8 # Calculated from Vanadium over Vanadium run
        print('*************************************************')
...
##### Here one sets up folders where to find input data and where to save results ####
    ...
    set_data_dir('ei200S_Cycle_10_02','cycle10_02','ei200')

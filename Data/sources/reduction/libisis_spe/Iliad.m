...
sample_map_file = {...
    '4to1.map'...
%    '4to1_mid_lowang.map'...
%    'mid_tubes_mid_lowang.map',...             % only for runs with mid_tubes spectra.dat
    };
...
% In the case of iron, the defaults are OK.
% if ei==35
%     bmin=14000;bmax=18000;
% elseif ei==70
%     bmin=16000;bmax=19000;
% elseif ei==110
%     bmin=16500;bmax=19500;
% elseif ei==156
%     bmin=12000;bmax=18000;
% elseif ei==180
%     bmin=14000;bmax=19000;
% elseif ei==240
%     bmin=14000;bmax=19000;
% end
...
hard_mask = '4to1_022.msk'; % appropriate for MAPS 4to1 mapping
...
% -----------------------------------------
% Put in your user_input area defined below

% The following file will give the correct detector delay times for all the iron runs:
detector_info_file = 'det_cal_dec09.nxs';    % comment out if not required
...
%user_input  = 'C:\temp\Iliad_test';  
%user_input='c:\Users\wkc26243\Documents\Toby\Fe\Aug10_v1\Ei1400';
user_input=get(homer_config,'instr_config_folder');
...
% -------------------------------------------------------------------------
% (Can be character string or cell array of character strings; comment out or set ='' to omit)
%user_output = 'C:\temp\Iliad_test'; 
user_output = 'c:\Users\wkc26243\Documents\Toby\Fe\Aug10_v1\SPE_EI787\SPE_EI800';
%user_output = '/sandata/home/merlin01/users/Hayden';   % example on Melehan


% Folder where raw data is to be found:
% --------------------------------------
%data_source = 'C:\data\test_experiment\raw';
data_source ='c:\Users\wkc26243\Documents\Toby\Fe\Aug10_v1\SPE_EI787';
%data_source = '/sandata/instrument/MERLIN/RAW';    % example on Melehan
...
rpath = make_path_from_par(mask_runno);

...
sample_map_file = {...
    '4to1_095.map'...                           % cycle specific mapping for MAPS
...
hard_mask = '4to1_095.msk'; % appropriate for MAPS 4to1 mapping
...
detector_info_file = 'detector_095.nxs';    % comment out if not required
...
%user_output = '/home/tgp98/Toby/experiments/iron/spe/095';
user_output = [pwd,'/EI400'];
...
%data_source  = '/archive/ndxmaps/Instrument/data/cycle_09_5';
data_source   = [pwd,'/EI400'];

...
sample_map_file = {...
    '4to1_102.map'...                           % cycle specific mapping for MAPS
...
hard_mask = '4to1_102.msk'; % appropriate for MAPS 4to1 mapping
...
detector_info_file = 'detector_102.nxs';    % comment out if not required
...
%user_input  = '/home/tgp98/Toby/instrument_files';  
%user_input  = 'c:\Users\wkc26243\Documents\work\Libisis\InstrumentFiles\maps'; 
user_input  ='';
...
%user_output = '/home/tgp98/Toby/experiments/iron/spe/102';
user_output = [hd,'/EI200'];
...
%data_source  = '/archive/ndxmaps/Instrument/data/cycle_10_2';
data_source  = [hd,'/EI200'];

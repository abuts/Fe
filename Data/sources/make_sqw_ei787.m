function make_sqw_ei787
% Create sqw file for the Ei=787meV Horace angle scan

par_dir=pwd;
spe_dir=[pwd,'/EI800']; 
sqw_dir=[pwd,'/EI800']; 

spename='MAP*_4to1_065_ei787.spe';    % template for spe file names
sqwname='Fe_ei787.sqw';
parname='4to1_065.par';

% Create the spe file names and psi array
spefile_template=fullfile(spe_dir,spename);
[spe_file,psi]=build_spefilenames(spefile_template, 11014:11060,    0, -0.5, -23);
[spe_file,psi]=build_spefilenames(spefile_template, 11063:11070,-23.5, -0.5, -27,  spe_file,psi);

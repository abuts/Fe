%%=============================================================================
%       Realign the crystal: Ei=1371 meV
% =============================================================================

data_dir = [pwd,'/sqw/'];
data_source =[pwd, '/sqw/Fe_ei1371_all.sqw'];
...
% -----------------------------------------------------------------
% Plane in horizontal: 
w2el=cut_sqw(data_source,proj,0.05,0.05,[-0.1,0.1],[-100,100],'-nopix');
plot(w2el)
...
% bragg_positions_view above. Also, the misorientation angle is 0.71 deg
...
% Get a=2.845 ANg, and rotangle=0.71 deg

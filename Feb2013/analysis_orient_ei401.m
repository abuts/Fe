%%=============================================================================
%       Realign the crystal: Ei=401 meV
% =============================================================================

data_dir = [pwd,'/sqw/'];
data_source =[pwd, '/sqw/Fe_ei401.sqw'];
...
% Get z=2.845 Ang c.f. 2.87 as the input value; this is consistent with
% looking at the radial scans through the Bragg peaks with
% bragg_positions_view above. Also, the misorientation angle is 0.80 deg
...
% Get a=2.845 ANg, and rotangle=0.72 deg

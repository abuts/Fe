...
peP5 = parWithCorrections([-0.4125,-0.1375,0,0.0875,0.3375;
                         153,15,0,11,131]);
peP5.cut_direction=[-1,1,-1];
peP5.dE =2;
peP5.dk =0.05;

peP6 = parWithCorrections([-0.3875,-0.1125,0,0.0875,0.3375;
                         151,11,0,15,131]);
peP6.cut_direction=[-1,-1,-1];
peP6.dE =2;
peP6.dk =0.05;

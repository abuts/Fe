...
for i=1:n_files
    ...
    par_pattern_w = repmat(par_pattern,size(cut_fitpar,1),1);
    
    
    not_valid = cut_fiterr>10 |cut_fitpar> par_pattern_w  | isnan(cut_fiterr) | isnan(cut_fitpar) ;
...
[en100,S100,S100_err,G100,G100_err] = extract_fitpar(10:5:280,[1,0,0],bind_map,fp_arr1);
[en110,S110,S110_err,G110,G110_err] = extract_fitpar(10:5:280,[1,1,0],bind_map,fp_arr1);
[en111,S111,S111_err,G111,G111_err] = extract_fitpar(10:5:280,[1,1,1],bind_map,fp_arr1);
%-------------------------------------------------------------

...
% #4
rp4 = parWithCorrections(repPoints3,bragg,[1,0,-1],dE,dK);

% #5
rp5 = parWithCorrections(repPoints3,bragg,[0,1,1],dE,dK);

% #6
rp6 = parWithCorrections(repPoints3,bragg,[0,1,-1],dE,dK);
